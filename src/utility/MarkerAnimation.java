...
import sbpack.LatLngInterpolator;
...
public class MarkerAnimation {
	public static void animateMarkerToGB(final Marker marker, final LatLng finalPosition, final LatLngInterpolator latLngInterpolator) {
		...
		final float durationInMs = Utils.mapInterval;
	...
	public static void animateMarkerToHC(final Marker marker, final LatLng finalPosition, final LatLngInterpolator latLngInterpolator) {
		...
		valueAnimator.setDuration(Utils.mapInterval);
		valueAnimator.start();
	}
	...
	public static void animateMarkerToICS(Marker marker, LatLng finalPosition, final LatLngInterpolator latLngInterpolator) {
		...
		animator.setDuration(Utils.mapInterval);
		animator.start();
	}
} 